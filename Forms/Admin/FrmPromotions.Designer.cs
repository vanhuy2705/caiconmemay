...
partial class FrmPromotions
{
    ...
    private void InitializeComponent(){
        split=new SplitContainer();grid=new DataGridView();txtCode=new TextBox();txtName=new TextBox();txtDesc=new TextBox();txtPercent=new TextBox();dtStart=new DateTimePicker();dtEnd=new DateTimePicker();chkActive=new CheckBox();btnNew=new Button();btnSave=new Button();btnDelete=new Button();
        SuspendLayout();
        ...
        var pageTitle=new Label{Text="Khuyến mãi",AutoSize=true,Font=new Font("Segoe UI Semibold",15F,FontStyle.Bold),ForeColor=Color.FromArgb(18,53,78),Location=new Point(6,6)};
        var pageSub=new Label{Text="Chương trình giảm giá áp dụng tự động theo thời gian",AutoSize=true,Font=new Font("Segoe UI",8.2F),ForeColor=Color.FromArgb(103,126,145),Location=new Point(8,34)};
        ...
        var title=new Label{Text="Thông tin khuyến mãi",AutoSize=true,Font=new Font("Segoe UI Semibold",13F,FontStyle.Bold),ForeColor=Color.FromArgb(18,53,78),Location=new Point(72,22)};
        var sub=new Label{Text="Chọn chương trình để chỉnh sửa",AutoSize=true,Font=new Font("Segoe UI",8F),ForeColor=Color.FromArgb(103,126,145),Location=new Point(73,48)};
        ...
        Add("Mã khuyến mãi *",txtCode);Add("Tên chương trình *",txtName);
        ...
        Add("Giảm (%) *",txtPercent);Add("Bắt đầu",dtStart);Add("Kết thúc",dtEnd);
