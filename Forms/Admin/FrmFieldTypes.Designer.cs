...
partial class FrmFieldTypes
{
    ...
    private void InitializeComponent(){
        split=new SplitContainer();grid=new DataGridView();txtSearch=new TextBox();btnRefresh=new Button();txtCode=new TextBox();txtName=new TextBox();txtDesc=new TextBox();chkActive=new CheckBox();btnNew=new Button();btnSave=new Button();btnDelete=new Button();
        SuspendLayout();
        ...
        var pageTitle=new Label{Text="Loại sân",AutoSize=true,Font=new Font("Segoe UI Semibold",15F,FontStyle.Bold),ForeColor=Color.FromArgb(18,53,78),Location=new Point(6,6)};
        var pageSub=new Label{Text="Phân nhóm sân theo loại hình thể thao",AutoSize=true,Font=new Font("Segoe UI",8.2F),ForeColor=Color.FromArgb(103,126,145),Location=new Point(8,34)};
        txtSearch.PlaceholderText="Tìm loại sân...";txtSearch.Location=new Point(6,8);txtSearch.Width=260;txtSearch.Anchor=AnchorStyles.Top|AnchorStyles.Right;
        ...
        var title=new Label{Text="Thông tin loại sân",AutoSize=true,Font=new Font("Segoe UI Semibold",13F,FontStyle.Bold),ForeColor=Color.FromArgb(18,53,78),Location=new Point(72,22)};
        var sub=new Label{Text="Chọn loại sân trong danh sách để chỉnh sửa",AutoSize=true,Font=new Font("Segoe UI",8F),ForeColor=Color.FromArgb(103,126,145),Location=new Point(73,48)};
        ...
        Add("Mã loại *",txtCode);Add("Tên loại sân *",txtName);
        // Mô tả multiline
        ...
        txtDesc.Location=new Point(20,y+20);txtDesc.Width=split.Panel2.ClientSize.Width-40;txtDesc.Height=80;txtDesc.Multiline=true;txtDesc.Anchor=AnchorStyles.Top|AnchorStyles.Left|AnchorStyles.Right;
        split.Panel2.Controls.AddRange(new Control[]{lbDesc,txtDesc});y+=108;
