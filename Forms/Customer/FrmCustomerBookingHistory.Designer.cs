...
partial class FrmCustomerBookingHistory
{
    ...
    private void InitializeComponent(){
        top=new Panel();cboStatus=new ComboBox();btnRefresh=new Button();btnPay=new Button();btnCancel=new Button();grid=new DataGridView();
        SuspendLayout();
        top.Dock=DockStyle.Top;top.Height=88;top.BackColor=Color.White;top.Padding=new Padding(12,8,12,8);
        var pageTitle=new Label{Text="Lịch sử đặt sân",AutoSize=true,Font=new Font("Segoe UI Semibold",15F,FontStyle.Bold),ForeColor=Color.FromArgb(18,53,78),Location=new Point(12,8)};
        var pageSub=new Label{Text="Theo dõi trạng thái, thanh toán hoặc hủy các lượt đặt của bạn",AutoSize=true,Font=new Font("Segoe UI",8.2F),ForeColor=Color.FromArgb(103,126,145),Location=new Point(14,34)};
        cboStatus.Location=new Point(12,54);cboStatus.Width=170;cboStatus.Height=32;cboStatus.DropDownStyle=ComboBoxStyle.DropDownList;
        ...
        btnCancel.Text="✕  Hủy đặt sân";btnCancel.Size=new Size(112,36);btnCancel.Anchor=AnchorStyles.Top|AnchorStyles.Right;
        ...
        top.Resize+=(s,e)=>{
            ...
            cboStatus.Width=Math.Max(140,btnRefresh.Left-cboStatus.Left-16);
        };
